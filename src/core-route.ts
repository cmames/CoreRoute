...
export class CoreRoute {
    #gets: Array<{ routePattern: string, regex: RegExp, paramNames: string[], handler:  CoreRouteRequestHandler }>;
    #puts: Array<{ routePattern: string, regex: RegExp, paramNames: string[], handler:  CoreRouteRequestHandler }>;
    #posts: Array<{ routePattern: string, regex: RegExp, paramNames: string[], handler:  CoreRouteRequestHandler }>;
    #deletes: Array<{ routePattern: string, regex: RegExp, paramNames: string[], handler:  CoreRouteRequestHandler }>;
    #patchs: Array<{ routePattern: string, regex: RegExp, paramNames: string[], handler:  CoreRouteRequestHandler }>;
...
/**
     ...
     * });
     */
    post(routePattern: string, callback : CoreRouteRequestHandler) {
        const { regex, paramNames } = this.#pathToRegex(routePattern);
        this.#posts.push({
            routePattern: routePattern,
            regex: regex,
     ...
     * });
     */
    delete(routePattern: string, callback : CoreRouteRequestHandler) {
        const { regex, paramNames } = this.#pathToRegex(routePattern);
        this.#deletes.push({
            routePattern: routePattern,
            regex: regex,
     ...
     * });
     */
    patch(routePattern: string, callback : CoreRouteRequestHandler) {
        const { regex, paramNames } = this.#pathToRegex(routePattern);
        this.#patchs.push({
            routePattern: routePattern,
            regex: regex,
    ...
    * @example
     ...
     * });
     */
    all(routePattern: string, callback : CoreRouteRequestHandler) {
